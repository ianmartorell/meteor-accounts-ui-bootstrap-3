(function() {
  ...
  var resetPassword = function() {
    ...
    var newPassword = document.getElementById('reset-password-new-password').value,
        passwordAgain = document.getElementById('reset-password-new-password-again').value;

    if (!Accounts._loginButtons.validatePassword(newPassword, (passwordAgain ? passwordAgain : "-1"))) {
      return;
    }
  ...
  var enrollAccount = function() {
    ...
    var password = document.getElementById('enroll-account-password').value,
        passwordAgain = document.getElementById('enroll-account-password-again').value;

    if (!Accounts._loginButtons.validatePassword(password, (passwordAgain ? passwordAgain : "-1"))) {
      return;
    }
